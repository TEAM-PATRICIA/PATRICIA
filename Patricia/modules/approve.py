...
from Patricia import dispatcher, DRAGONS
...
from Patricia.modules.helper_funcs.chat_status import (bot_admin, user_admin)
...
def approve(update, context):
	 ...
	 message.reply_text(f"[{member.user['first_name']}](tg://user?id={member.user['id']}) has been approved in {chat_title}! They will now be ignored by automated admin actions like locks, blocklists, and antiflood.*Powered By @PATRICIA_ROBOT*", parse_mode=ParseMode.MARKDOWN)
