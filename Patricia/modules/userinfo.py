...
from Patricia import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Patricia.__main__ import STATS, TOKEN, USER_INFO
...
from Patricia.modules.sql.afk_sql import is_afk, check_afk_status
from Patricia.modules.sql.users_sql import get_user_num_chats
from Patricia.modules.sql.feds_sql import get_user_fbanlist
from Patricia.modules.helper_funcs.chat_status import sudo_plus
from Patricia.modules.helper_funcs.extraction import extract_user
from Patricia import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
